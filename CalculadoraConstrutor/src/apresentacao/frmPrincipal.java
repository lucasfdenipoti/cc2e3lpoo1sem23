...
public class frmPrincipal extends javax.swing.JDialog
{
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(lblPrimeiroNumero, javax.swing.GroupLayout.DEFAULT_SIZE, 215, Short.MAX_VALUE)
    ...
    private void calcular(String operacao)
    {
        ...
        Validacao validacao = new Validacao(
                ...
                txfSegundoNumero.getText(), 
                operacao);
        if(validacao.getMensagem().equals("Não é possível dividir por zero"))
        {
            JFrame box = new JFrame();
            JOptionPane.showMessageDialog(box, validacao.getMensagem());
        }
        if(validacao.getMensagem().equals("Erro de conversão"))
        {
            JFrame box = new JFrame();
            JOptionPane.showMessageDialog(box, validacao.getMensagem());
        }
